  ...
  return (
    <section className="bg-gradient-to-r from-pink-200 to-pink-400 p-8 md:p-12 lg:p-16 mx-6 mt-6 mb-6 rounded-2xl border-4 border-black shadow-2xl flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="space-y-6 text-lg leading-relaxed text-gray-800 max-w-3xl text-center">
        ...
        <p>
          <strong>FitMate</strong> is a cutting-edge web application designed to
          transform the way people shop for clothes online. With the rise of
          e-commerce, the challenge of finding the perfect fit without trying on
          clothes in person has become a significant pain point for customers.
          FitMate bridges this gap by providing an innovative solution: virtual
          fitting.
        </p>
        ...
        <p>
          ...
          their bodies without ever stepping foot into a fitting room. By simply
          uploading a body photo and an image of the desired outfit, our
          advanced algorithms generate a virtual fitting experience that allows
          users to see how the garment will fit and suit them.
        </p>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            Tailored Fit Recommendations: Personalized suggestions based on your
            body shape and the clothing’s design.
          </li>
          <li>
        ...
        <p>
          At FitMate, we aim to make online shopping more convenient, enjoyable,
          and accurate for everyone. Our goal is to reduce the frustration of
          returns and misfit garments by offering a virtual fitting room that
          gives users confidence in their purchases.
        </p>
