    ...
    <LayoutWithNavbar>
      <section className="bg-gradient-to-r from-red-200 to-red-400 p-8 md:p-12 lg:p-16 mx-6 mt-6 mb-6 rounded-2xl border-4 border-black shadow-2xl flex flex-col items-center justify-center min-h-screen">
        ...
        <p className="mb-4 text-gray-700">
          At FitMate, accessible from fitmate.com, we are committed to
        ...
        <p className="mb-4 text-gray-700">
          When you use FitMate, we may collect the following types of
          information:
        </p>
        <ol className="list-decimal ml-6 mb-4 text-gray-700">
          ...
          <li>
            ...
            application, including your interactions with our services, the
            pages you visit, and the time spent on those pages.
          </li>
          <li>
            <strong>Device Information:</strong> Information about the device
            you use to access our application, including IP address, browser
            type, and operating system.
          </li>
          <li>
            <strong>Photos:</strong> Body photo and clothes photo uploaded by
            you to generate fitting results.
          </li>
        </ol>
        ...
        <ul className="list-disc ml-6 mb-4 text-gray-700">
          <li>
            ...
            operating our application and providing our services. These parties
